...
<%@ include file="/WEB-INF/jsp/admin/sidebar.jsp" %>
	<div id="content">
		<div class="container-fluid">
			<hr>
			<div class="row-fluid">
				<form action="SizeServlet.do" method="get" class="form-horizontal">
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<input type="hidden" name="method" value="save" /> <input
									type="hidden" name="sizeId" value="${size.sizeId}" />
								<div class="control-group">
									<label class="control-label">尺码值：</label>
									<div class="controls">
										<input type="text" name="sizeValue" value="${size.sizeValue}"
											class="span11">
									</div>
									<div class="form-actions">
										<button type="submit" class="btn btn-success">保存</button>
										<a href="SizeServlet.do?method=list">取消</a>
									</div>
								</div>
							</div>
						</div>
