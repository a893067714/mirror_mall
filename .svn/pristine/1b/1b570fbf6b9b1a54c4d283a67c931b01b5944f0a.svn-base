	...
	<div class="all">
		...
		<div class="body_wrap clearfix">
			...
			<form action="UpdateCartServlet.do?method=settlement" method="post">
				<div class="car_list">
					<div class="shop_wrap">
						<c:forEach items="${CartQueryViews}" var="arr">
							<div class="shop">
							...
							<div class="shop_body">
								...
								<input type="checkbox" class="s_checkbox" name="cartId"
									value="${arr.cartId }" />
								<div class="item_form">
									<div class="shop_goods">
										...
										<span class="promise extend_return_d"> <i></i> <a
											...
											name="productSkuId" value="${arr.productSkuId }"/ > <input
									...
									<div class="shop_quantity">
										<div class="shop_quantity_form">
											...
											<a
												href="UpdateCartServlet.do?method=updateQuantity&m=sup&cartId=${arr.cartId}&quantity=${arr.quantity}">
												- </a> <input type="text" name="quantity"
												value="${arr.quantity}" style="width: 35px;"> <a
												href="UpdateCartServlet.do?method=updateQuantity&m=add&cartId=${arr.cartId}&quantity=${arr.quantity}">
												+ </a>
									...
									<div class="shop_num">
										<strong>${arr.priceCurrent*arr.quantity}</strong>
									</div>
									<div class="shop_ops">
										<a
				...
				<div class="car_footer">
					...
					<div class="car_footer_price car_footer_right">
						<span class="car_footer_price1"> 总价: </span> <span
							class="car_footer_price_num"> ${totalPrice }</span> <br /> <span>
