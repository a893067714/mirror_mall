...
<%@ include file="/WEB-INF/jsp/admin/sidebar.jsp" %>
	<div id="content">
		<div class="container-fluid">
			<hr>
			<div class="row-fluid">
				<form action="RoleMenuServlet.do" method="get"
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<input type="hidden" name="method" value="save" /> <input
									type="hidden" name="roleMenuId" value="${roleMenu.roleMenuId}" />
								<div class="control-group">
									<label class="control-label"> <span
										style="position: absolute; left: 123px;">角色名：</span> <select
										name="roleId" class="span11" style="margin-left: 200px">
								...
								<div class="control-group">
									<label class="control-label"> <span
										style="position: absolute; left: 123px;">菜单名：</span> <select
										name="menuId" class="span11" style="margin-left: 200px">
											<option value="0">空</option>
								...
								<div class="form-actions">
									...
									<a href="RoleMenuServlet.do?method=list">取消</a>
								</div>
							</div>
						</div>
					</div>
