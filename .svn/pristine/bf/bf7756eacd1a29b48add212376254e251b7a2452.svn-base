...
<%@ include file="/WEB-INF/jsp/admin/sidebar.jsp" %>
	<div id="content">
		<div class="container-fluid">
			<hr>
			<div class="row-fluid">
				<form action="ModuleServlet.do" method="get"
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<input type="hidden" name="method" value="save" /> <input
									type="hidden" name="moduleId" value="${module.moduleId}" />
								<div class="control-group">
									<label class="control-label">模块名称：</label>
									<div class="controls">
										<input type="text" name="moduleName"
											value="${module.moduleName}" class="span11">
									</div>
								</div>
								<div class="form-actions">
									<button type="submit" class="btn btn-success">保存</button>
									<a href="ModuleServlet.do?method=list">取消</a>
								</div>
							</div>
						</div>
					</div>
