...
<%@ include file="/WEB-INF/jsp/admin/sidebar.jsp" %>
	<div id="content">
		<div class="container-fluid">
			<hr>
			<div class="row-fluid">
				<form action="TypeBigServlet.do" method="get"
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								...
								<input
									type="hidden" name="typeBigId" value="${typeBig.typeBigId}" />
								<div class="control-group">
									<label class="control-label">大分类名称：</label>
									<div class="controls">
										<input type="text" name="typeBigName" value="${typeBig.typeBigName}"
											class="span11">
									</div>
									<div class="form-actions">
										<button type="submit" class="btn btn-success">保存</button>
										<a href="TypeBigServlet.do?method=list">取消</a>
									</div>
								</div>
							</div>
						</div>
