...
<%@ include file="/WEB-INF/jsp/admin/sidebar.jsp" %>
	<div id="content">
		<div class="container-fluid">
			<hr>
			<div class="row-fluid">
				<form action="TypeDetailServlet.do" method="get"
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<input type="hidden" name="method" value="save" /> <input
									type="hidden" name="typeDtlId" value="${typeDetail.typeDtlId}" />
								<div class="control-group">
									<label class="control-label">大分类名称：</label>
									<div class="controls">
										<select style="width: 250px" name="typeBigId">
								...
								<div class="control-group">
									<label class="control-label">详细分类名称：</label>
									<div class="controls">
										<input type="text" name="typeDtlName"
											value="${typeDetail.typeDtlName}" class="span11">
									</div>
									<div class="form-actions">
										<button type="submit" class="btn btn-success">保存</button>
										<a href="TypeDetailServlet.do?method=list">取消</a>
									</div>
								</div>
							</div>
						</div>
