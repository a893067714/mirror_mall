		...
		<div class="container-fluid">
			...
			<div class="widget-box">
				...
				<form class="form-horizontal" method="get"
					action="BrandServlet.do?method=list">
					<div class="controls">
						<span>品牌名称：</span> <input type="text" name="brandName"
							value="${brandName}" /> <input type="submit" value="查询"
							class="btn btn-success">
					</div>
					<hr>
				</form>
				<a href="BrandServlet.do?method=edit"><button
						...
						<tbody>
							...
							<c:forEach items="${listBrand }" var="brand">
								<tr>
									...
									<td>${brand.name }</td>
									<td><a
										href="BrandServlet.do?method=edit&brandId=${brand.brandId }">编辑</a>
										<a
										href="BrandServlet.do?method=delete&brandId=${brand.brandId }">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
